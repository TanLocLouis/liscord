...
const CreateChannel = (props: CreateChannelProps) => {
    ...
    const handleCreateChannelSubmitted = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            addToast("error", "Failed to create channel. Please try again.");
        } finally {
            ...
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] bg-[var(--color-secondary)] rounded-lg flex justify-center items-center">
                <form className="flex flex-col justify-center items-center w-full h-full m-5" onSubmit={handleCreateChannelSubmitted}>
                    <div className="w-full flex justify-between items-center mb-5">
                        <h1 className="text-2xl text-[var(--color-text-primary)]">Create new Channel</h1>
                    ...
                    <div className="w-full">
                        <label htmlFor="channel-name" className="block">Channel Name</label>
                        <input
                            type="text"
                            name="channelName"
                            id="channel-name"
                    ...
                    <div className="w-full mt-2">
                        <label htmlFor="channel-type" className="block">Channel Type</label>
                        <select
                            name="type"
                            id="channel-type"
                            value={formData.type}
