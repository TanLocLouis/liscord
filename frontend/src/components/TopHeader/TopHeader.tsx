                ...
                {userInfo &&
                    <>
                        <div onClick={handleProfileClicked}>
                            <Link className="link border-2 rounded-lg b-2 border-[var(--color-text-primary)] p-1 flex justify-center items-center shadow-[0_2px_10px_rgba(255,255,255,0.5)] hover:bg-[var(--color-primary-soft)] cursor-pointer">
