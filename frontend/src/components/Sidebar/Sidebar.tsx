...
const Sidebar = () => {
    ...
    // 
    const handleServerClicked = (serverName: string) => {
    ...
    return (
        <div>
            <div className="sidebar pt-12 pb-12 bg-[var(--color-secondary)] w-16 h-screen flex flex-col align-center items-center">
                <ul className="overflow-y-auto">
                    {serverList.map((server) => (
                        <li key={server.server_id} onClick={() => handleServerClicked(server.server_name)}>
            ...
            <SidebarChannels serverName={currentServerName}/>
        </div>
    )
}
